...
void test()
{
    ...
    Form *sf = intern.makeForm("shrubbery creation", "sf_target");
    Form *rf = intern.makeForm("robotomy request", "rf_target");
    Form *pf = intern.makeForm("presidential pardon", "pf_target");

    try 
    {
        //Form *err = intern.makeForm("aa", "err_target");
